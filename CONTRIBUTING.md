...
Anyone interested in end-to-end autonomous driving is welcomed to contribute to this repo:
...
2. Clone this repo to your own machine.
    ```
    git clone https://github.com/<your_username>/awesome-end-to-end-autonomous-driving.git
    ```
